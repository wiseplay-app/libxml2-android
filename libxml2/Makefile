...
am__libxml2_la_SOURCES_DIST = SAX.c entities.c encoding.c error.c \
	...
	triostr.c trio.c
am_libxml2_la_OBJECTS = SAX.lo entities.lo \
	encoding.lo error.lo \
	parserInternals.lo parser.lo tree.lo \
	hash.lo list.lo xmlIO.lo xmlmemory.lo \
	uri.lo valid.lo xlink.lo \
	...
	dict.lo SAX2.lo xmlwriter.lo \
	legacy.lo chvalid.lo pattern.lo \
	xmlsave.lo xmlmodule.lo schematron.lo
#am_libxml2_la_OBJECTS = SAX.lo entities.lo \
#	encoding.lo error.lo \
#	parserInternals.lo parser.lo tree.lo \
#	hash.lo list.lo xmlIO.lo xmlmemory.lo \
#	uri.lo valid.lo xlink.lo HTMLparser.lo \
#	HTMLtree.lo debugXML.lo xpath.lo \
#	xpointer.lo xinclude.lo nanohttp.lo \
#	nanoftp.lo DOCBparser.lo catalog.lo \
#	globals.lo threads.lo c14n.lo \
#	xmlstring.lo xmlregexp.lo \
#	xmlschemas.lo xmlschemastypes.lo \
#	xmlunicode.lo triostr.lo trio.lo \
#	xmlreader.lo relaxng.lo dict.lo \
#	SAX2.lo xmlwriter.lo legacy.lo \
#	chvalid.lo pattern.lo xmlsave.lo \
#	xmlmodule.lo schematron.lo
...
ACLOCAL = ${SHELL} /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8/missing --run aclocal-1.11
AMTAR = ${SHELL} /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8/missing --run tar
AR = ar
AS = as
AUTOCONF = ${SHELL} /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8/missing --run automake-1.11
AWK = awk
BASE_THREAD_LIBS = 
C14N_OBJ = c14n.c
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8/missing --run makeinfo
...
PYTHON_LIBS = -L/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/config -ldl -framework CoreFoundation -lpython2.7
...
Z_CFLAGS = 
Z_LIBS = -lz
abs_builddir = /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8
abs_srcdir = /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8
abs_top_builddir = /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8
abs_top_srcdir = /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /Users/chenlunyao/Documents/workspace/mobiledevice/imobiledevice-android/libxml2-2.7.8/install-sh
...
SUBDIRS = include . doc example xstc python
DIST_SUBDIRS = include . doc example python xstc
INCLUDES = -I$(top_builddir)/include -I./include  -D_REENTRANT  
bin_SCRIPTS = xml2-config
lib_LTLIBRARIES = libxml2.la
libxml2_la_LIBADD = -lpthread -lz $(ICONV_LIBS) -lm 
...
tests: XMLtests XMLenttests NStests IDtests Errtests APItests Readertests SAXtests XMLPushtests HTMLtests HTMLPushtests  Validtests URItests Patterntests XPathtests XPtrtests XIncludetests C14Ntests Scripttests Catatests Regexptests Automatatests Schemastests Relaxtests Schematrontests Threadtests Timingtests VTimingtests  RelaxNGPythonTests SchemasPythonTests ModuleTests
	@(if [ "python" != "" ] ; then cd python ; \
	    $(MAKE) MAKEFLAGS+=--silent tests ; fi)
...
install-data-local: 
	./install-sh -c -d $(DESTDIR)$(BASE_DIR)/$(DOC_MODULE)
	-/usr/bin/install -c -m 0644 $(srcdir)/Copyright $(DESTDIR)$(BASE_DIR)/$(DOC_MODULE)
	./install-sh -c -d $(DESTDIR)$(EXAMPLES_DIR)
